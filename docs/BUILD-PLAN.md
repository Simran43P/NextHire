...
| **Progress** | **44 of 44 done** — every phase complete |
...
| **Phase 4** — Application lifecycle | 5 | M | **Done** | The loop the landing page promises |
| | **44** | | **44 done** | |
...
## Phase 4 — Application lifecycle  *(5 steps — done)*
